    ...
    <Wrapper>
      <Form method="post" className="form">
        ...
        <div className="form-center">
          <FormRow labelText="nama barang" name="namaBarang" defaultValue={barang.namaBarang} />
          <FormRow labelText="jumlah barang" name="jumlahBarang" defaultValue={barang.jumlahBarang} />
          <FormRowSelect
            labelText="lokasi"
            name="lokasiGudang"
